...
class FlameLogoComponent extends PositionComponent
  ...
  void render(Canvas canvas) {
    ...
    // // Left flame (smaller, left side)
    // final leftFlamePath = Path()
    //   ..moveTo(baseX + w * 0.35, baseY + h * 0.75) // Bottom
    //   ..cubicTo(
    //     baseX + w * 0.25,
    //     baseY + h * 0.65,
    //     baseX + w * 0.2,
    ...
    //   Offset(baseX + w * 0.3, baseY + h * 0.35),
    //   Offset(baseX + w * 0.35, baseY + h * 0.75),
    //   [
    ...
    // // Right flame (smallest, right side)
    // final rightFlamePath = Path()
    //   ..moveTo(baseX + w * 0.7, baseY + h * 0.65) // Bottom
    //   ..cubicTo(
    //     baseX + w * 0.65,
    //     baseY + h * 0.6,
    //     baseX + w * 0.63,
